...
-	[API Calls](#API-Calls)
	...
	*	[Dashboard support](#Non-Dashboard)
		-	[Actions](#Actions-Dashboard)
			*	[Add a new Action](#Add-a-new-Action-Dashboard)
			*	[Get Actions](#Get-Actions)
			*	[Remove an Action](#Remove-an-Action-Dashboard)
		-	[Actuators](#Actuators-Dashboard)
			*	[Add a new Actuator](#Add-a-new-Actuator-Dashboard)
			*	[Get Actuators](#Get-Actuators-Dashboard)
		-	[Configurations](#Configurations-Dashboard)
			*	[Add a new Configuration](#Add-a-new-Configuration-Dashboard)
			*	[Get Configurations](#Get-Configurations-Dashboard)
			*	[Remove an Configuration](#Remove-an-Configuration-Dashboard)
		-	[Descriptions](#Descriptions-Dashboard)
			*	[Add a new Description](#Add-a-new-Description-Dashboard)
		-	[Probes](#Probes-Dashboard)
			*	[Add a new Probe](#Add-a-new-Probe-Dashboard)
			*   [Get Probes](#Get-Probes-Dashboard)
			*   [Remove a Probe](#Remove-a-Probe-Dashboard)
		-	[Resources](#Resources-Dashboard)
			*	[Add a new Resource](#Add-a-new-Resource-Dashboard)
			*	[Get Resources](#Get-Resources-Dashboard)
			*	[Configure Actions](#Configure-Actions-Dashboard)
			*	[Get Scores](#Get-Scores-Dashboard)
 -	[GUI](#GUI)
